  ...
  return (
    <div className="flex flex-col w-full bg-background pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <p className="text-sm font-bold tracking-widest text-primary uppercase mb-3" aria-hidden="true">About Us</p>
          <h1 className="font-serif text-4xl md:text-6xl font-bold text-foreground mb-6">About Anglo School</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          ...
          >
            ...
            <h2 id="mission-heading" className="font-serif text-2xl font-bold text-foreground mb-4">Our Mission</h2>
          ...
          >
            ...
            <h2 id="vision-heading" className="font-serif text-2xl font-bold mb-4">Our Vision</h2>
        ...
        <section aria-labelledby="history-heading" className="grid lg:grid-cols-2 gap-12 items-center mb-24">
          <motion.div
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 id="history-heading" className="font-serif text-3xl md:text-4xl font-bold text-foreground">History</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="font-serif text-2xl font-bold text-secondary">The Arya Samaj Legacy</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-primary/5 p-6 rounded-xl border border-primary/20 mt-6">
              <p className="font-hindi text-2xl font-bold text-accent mb-2">अज्ञानान्धकारं निवार्य ज्ञानालोकं कुरु।</p>
        ...
        <section aria-labelledby="values-heading">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 id="values-heading" className="font-serif text-3xl md:text-5xl font-bold text-foreground mb-4">School Values</h2>
            <p className="text-muted-foreground text-lg">
              Four timeless principles guide everything we do inside and outside the classroom.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="font-serif text-xl font-bold text-foreground mb-2">{val.title}</h3>
